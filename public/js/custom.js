        ...
        if ($BODY.hasClass('nav-sm')) {
            if ($li.is('.active-sm')) {
                ...
                if (!$li.parent().is('.child_menu')) {
                    $SIDEBAR_MENU.find('li').removeClass('active-sm');
...
function datatablesRowClicked(table_id, func) {
    $('#' + table_id + ' tr').on('click', 'td', function() {
